#!/usr/bin/env python3
"""
Simple database setup for PostgreSQL mutual fund database
"""
...
def create_database():
    ...
    try:
        ...
        with conn.cursor() as cursor:
            ...
            """)
            print("✅ Created mf_factsheet table")
            ...
            """)
            print("✅ Created mf_nav_history table")
            ...
            """)
            print("✅ Created mf_fund_ratings table")
            ...
            """)
            print("✅ Created mf_returns table")
            ...
            """)
            print("✅ Created mf_fund_analytics table")
            ...
            """)
            print("✅ Created mf_portfolio_holdings table")
...
def insert_sample_data(conn):
    """Insert sample mutual fund data"""
    ...
    with conn.cursor() as cursor:
        ...
        for fund in sample_funds:
            ...
            # Generate 30 days of NAV data (smaller for testing)
            for i in range(30):
                ...
                """, (fund_code, date.date(), round(nav_value, 4)))
            
            print(f"✅ Generated NAV history for {fund['fund_name']}")
        
        # Generate fund ratings
        rating_agencies = ['CRISIL', 'ICRA', 'Value Research']
        ...
        for fund in sample_funds:
            ...
            for agency in rating_agencies:
                ...
                """, (fund_code, agency, rating, rating_date.date()))
        ...
        for fund in sample_funds:
            ...
            # Generate 5-8 holdings per fund
            num_holdings = random.randint(5, 8)
